...
const config = {
  "generator": {
    "name": "fetchConversationDialogsForCreatingAudio",
    "provider": {
      "fromEnvVar": null,
      "value": "prisma-client-js"
    },
    "output": {
      "value": "/Users/tg/Documents/GitHub/functional-vietnamese/cloud-functions/fetch-conversation-dialogs-for-creating-audio/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "cloud-functions/fetch-conversation-dialogs-for-creating-audio/generated",
    "fetch-conversation-dialogs-for-creating-audio/generated",
  ]
...
path.join(process.cwd(), "cloud-functions/fetch-conversation-dialogs-for-creating-audio/generated/libquery_engine-darwin-arm64.dylib.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-rhel-openssl-3.0.x.so.node");
path.join(process.cwd(), "cloud-functions/fetch-conversation-dialogs-for-creating-audio/generated/libquery_engine-rhel-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "cloud-functions/fetch-conversation-dialogs-for-creating-audio/generated/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "cloud-functions/fetch-conversation-dialogs-for-creating-audio/generated/schema.prisma")
