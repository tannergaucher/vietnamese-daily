...
const config = {
  "generator": {
    "name": "createConversationImage",
    "provider": {
      "fromEnvVar": null,
      "value": "prisma-client-js"
    },
    "output": {
      "value": "/Users/tg/Documents/GitHub/functional-vietnamese/cloud-functions/create-conversation-image/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "cloud-functions/create-conversation-image/generated",
    "create-conversation-image/generated",
  ]
...
path.join(process.cwd(), "cloud-functions/create-conversation-image/generated/libquery_engine-darwin-arm64.dylib.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-rhel-openssl-3.0.x.so.node");
path.join(process.cwd(), "cloud-functions/create-conversation-image/generated/libquery_engine-rhel-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "cloud-functions/create-conversation-image/generated/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "cloud-functions/create-conversation-image/generated/schema.prisma")
