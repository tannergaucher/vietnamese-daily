...
exports.emergencyExample = exports.healthExample = exports.shoppingExample = exports.hotelExample = exports.transportationExample = exports.marketExample = exports.restaurantExample = exports.streetExample = void 0;
exports.streetExample = {
    // type: "at the restaurant",
    text: "Ordering phở chiên phồng from a street vendor in Hanoi.",
};
exports.restaurantExample = {
    // type: "at the cafe",
    text: "Ordering a cà phê sữa đá from a café in Saigon.",
};
exports.marketExample = {
    // type: "at the market",
    text: "Shopping for fresh produce at a local market in Hanoi.",
};
exports.transportationExample = {
    // type: "asking a local for directions",
    text: "Asking for directions to the nearest bus stop in Saigon.",
};
exports.hotelExample = {
    // type: "at the hotel",
    text: "Checking into a hotel in Hanoi.",
};
exports.shoppingExample = {
