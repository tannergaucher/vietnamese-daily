...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/tg/Documents/GitHub/functional-vietnamese/cloud-functions/send-confirmation-email/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "cloud-functions/send-confirmation-email/generated",
    "send-confirmation-email/generated",
  ]
...
path.join(process.cwd(), "cloud-functions/send-confirmation-email/generated/libquery_engine-darwin-arm64.dylib.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-rhel-openssl-3.0.x.so.node");
path.join(process.cwd(), "cloud-functions/send-confirmation-email/generated/libquery_engine-rhel-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "cloud-functions/send-confirmation-email/generated/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "cloud-functions/send-confirmation-email/generated/schema.prisma")
