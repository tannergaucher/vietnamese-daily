...
exports.fetchSituationForCreatingDialog = void 0;
const functions = __importStar(require("@google-cloud/functions-framework"));
const pubsub_1 = require("@google-cloud/pubsub");
const generated_1 = require("./generated");
functions.cloudEvent("fetchSituationForCreatingDialog", () => __awaiter(void 0, void 0, void 0, function* () {
    const prisma = new generated_1.PrismaClient();
    const pubsub = new pubsub_1.PubSub({
        projectId: "daily-vietnamese",
        keyFilename: "./service-account.json",
    });
    yield fetchSituationForCreatingDialog({
        prisma,
        pubsub,
    });
}));
...
exports.fetchSituationForCreatingDialog = fetchSituationForCreatingDialog;
