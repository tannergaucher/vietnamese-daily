...
functions.http("createDialog", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var dialogSituation, model, prisma, pubsub, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                dialogSituation = req.body.dialogSituation;
                if (!dialogSituation) {
                    res.status(400).send("dialogSituation is required");
                    return [2 /*return*/];
                }
                model = (0, typechat_1.createLanguageModel)(process.env);
                ...
                return [4 /*yield*/, createDialog({
                        dialogSituation: dialogSituation,
                        model: model,
                        prisma: prisma,
                        pubsub: pubsub,
                    })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3: throw new Error("Failed to generate conversation dialog");
            }
        });
    });
}
